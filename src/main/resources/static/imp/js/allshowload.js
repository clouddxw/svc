...
$.ajax({
    url: 'http://svc.iresearch.cn/api/svc/vip/allshow/get1st',
    type: 'get',
    dataType: 'json',
    //data:data,
    jsonp: 'callback',
...
function getnorm() {
    ...
    $.ajax({
        url: "http://svc.iresearch.cn/api/svc/vip/allshow/getnorm",
        type: 'post',
        dataType: 'json',
...
function  getshow(showname){
	$.ajax({
	    url: 'http://svc.iresearch.cn/api/svc/vip/allshow/getshow',
	    type: 'post',
	    dataType: 'json',
        data:{
            showname:showname
