...
$.ajax({
    url: 'http://svc.iresearch.cn/api/svc/vip/allbrand/get1st',
    type: 'get',
    dataType: 'json',
    //data:data,
    jsonp: 'callback',
...
function getnorm() {
    ...
    $.ajax({
        url: "http://svc.iresearch.cn/api/svc/vip/allbrand/getnorm",
        type: 'post',
        dataType: 'json',
...
//	var normcondi=encodeURIComponent(normcon.replace(/"/g,""));
	$.ajax({
	    url: 'http://svc.iresearch.cn/api/svc/vip/allbrand/getbrand',
	    type: 'post',
	    dataType: 'json',
	    data:{
	        brandname:brandname
 ...
 function  getoneshow(showname,disp){
	$.ajax({
	    url: 'http://svc.iresearch.cn/api/svc/vip/allbrand/getoneshow',
	    type: 'post',
	    dataType: 'json',
	    data:{
	        showname:showname
