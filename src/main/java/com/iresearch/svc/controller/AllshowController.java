...
public class AllshowController {
        private static Logger logger = LoggerFactory.getLogger(AllshowController.class);
        ...
        public Object get1st(HttpServletRequest request) {
            ...
            if (asexist) {
                ...
                allshowmax = allshowmapper.getAllshow(norm);
            ...
            if(redisUtils.hasKey(showbrandmaxkey)){
                ...
                showbrandmax=allshowmapper.getShowbrand(shownamemax,norm);
            }
            ...
            if(redisUtils.hasKey(showbrandavgkey)){
                ...
                showbrandavg=allshowmapper.getShowbrand(shownameavg,norm);
            }
