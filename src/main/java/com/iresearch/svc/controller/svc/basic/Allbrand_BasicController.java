...
@Slf4j
@RequestMapping("/api/svc/basic/allbrand")
@RestController
public class Allbrand_BasicController {
    ...
    public Object get1st(HttpServletRequest request) {
        ...
        List<Brand> allbrandmax=allbrandService.getAllbrand_Basic(allbrandkey,norm);
        ...
        List<Brandshow> brandshowmax=allbrandService.getBrandshow_Basic(brandshowmaxkey,brandnamemax,norm);
        List<Brandtrend> brandtrendmax=allbrandService.getBrandtrend_Basic(brandtrendmaxkey,brandnamemax,norm);
        ...
        List<Brandshow> brandshowavg=allbrandService.getBrandshow_Basic(brandshowavgkey,brandnameavg,norm);
        List<Brandtrend> brandtrendavg=allbrandService.getBrandtrend_Basic(brandtrendavgkey,brandnameavg,norm);
    ...
    public Object getbrand(String brandname,HttpServletRequest request){
        ...
        List<Brandshow> brandshow=allbrandService.getBrandshow_Basic(brandshowkey,brandname,norm);
        List<Brandtrend> brandtrend=allbrandService.getBrandtrend_Basic(brandtrendkey,brandname,norm);
    ...
    @SysServiceLog(project="svc",model = "品牌排名详情")
    public Object getoneshow(String showname,HttpServletRequest request){
        HttpSession session=request.getSession();
        log.info(showname);
