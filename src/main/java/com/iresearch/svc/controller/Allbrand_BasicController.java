...
@RequestMapping("/basic/allbrand")
@Controller
public class Allbrand_BasicController {
    ...
    public Object get1st(HttpServletRequest request) {
        ...
        String allbrandkey="basic_allbrand_"+Normmap.normmap(norm);
        boolean asexist = redisUtils.hasKey(allbrandkey);
        if (asexist) {
            allbrandmax =(List<Brand>)redisUtils.get(allbrandkey);
        } else {
            allbrandmax = allbrandmapper.getAllbrand_Basic(norm);
        ...
        String allshowrkkey="basic_allshowrk_"+Normmap.normmap(norm);
        ...
        String brandtypemaxkey="basic_brandtype_"+brandnamemax;
        ...
        String brandshowmaxkey="basic_brandshow_"+brandnamemax+Normmap.normmap(norm);
        ...
        if(redisUtils.hasKey(brandshowmaxkey)){
            ...
            brandshowmax=allbrandmapper.getBrandshow_Basic(brandnamemax,norm);
            redisUtils.set(brandshowmaxkey,brandshowmax,3600);
        }

        String brandtrendmaxkey="basic_brandtrend_"+brandnamemax+Normmap.normmap(norm);;
        ...
        if(redisUtils.hasKey(brandtrendmaxkey)){
            ...
            brandtrendmax=allbrandmapper.getBrandtrend_Basic(brandnamemax,norm);
            redisUtils.set(brandtrendmaxkey,brandtrendmax,3600);
        }

        String t1shownamemax=brandshowmax.get(0).getShow();
        String showtypemaxkey="basic_showtype_"+t1shownamemax;
        String bdindexmaxkey="basic_bdindex_"+t1shownamemax;
        String wbindexmaxkey="basic_wbindex_"+t1shownamemax;
        String wxindexmaxkey="basic_wxindex_"+t1shownamemax;
        String tgimaxkey="basic_showtgi_"+t1shownamemax;
        ...
        String brandtypeavgkey="basic_brandtype_"+brandnameavg;
        ...
        String brandshowavgkey="basic_brandshow_"+brandnameavg+Normmap.normmap(norm);
        ...
        if(redisUtils.hasKey(brandshowavgkey)){
            ...
            brandshowavg=allbrandmapper.getBrandshow_Basic(brandnameavg,norm);
            redisUtils.set(brandshowavgkey,brandshowavg,3600);
        }

        String brandtrendavgkey="basic_brandtrend_"+brandnameavg+Normmap.normmap(norm);;
        ...
        if(redisUtils.hasKey(brandtrendavgkey)){
            ...
            brandtrendavg=allbrandmapper.getBrandtrend_Basic(brandnameavg,norm);
            redisUtils.set(brandtrendavgkey,brandtrendavg,3600);
        }

        String t1shownameavg=brandshowavg.get(0).getShow();
        String showtypeavgkey="basic_showtype_"+t1shownameavg;
        String bdindexavgkey="basic_bdindex_"+t1shownameavg;
        String wbindexavgkey="basic_wbindex_"+t1shownameavg;
        String wxindexavgkey="basic_wxindex_"+t1shownameavg;
        String tgiavgkey="basic_showtgi_"+t1shownameavg;
    ...
    public Object getbrand(HttpServletRequest request){
        ...
        String brandtypekey="basic_brandtype_"+brandname;
        String brandshowkey="basic_brandshow_"+brandname+Normmap.normmap(norm);
        String brandtrendkey="basic_brandtrend_"+brandname+Normmap.normmap(norm);
        Brandtype brandtype;
        ...
        if(redisUtils.hasKey(brandshowkey)){
            ...
            brandshow=allbrandmapper.getBrandshow_Basic(brandname,norm);
        ...
        if(redisUtils.hasKey(brandtrendkey)){
            ...
            brandtrend=allbrandmapper.getBrandtrend_Basic(brandname,norm);
            redisUtils.set(brandtrendkey,brandtrend,3600);
        }

        String t1showname=brandshow.get(0).getShow();
        String t1showtypekey="basic_showtype_"+t1showname;
        String bdindexkey="basic_bdindex_"+t1showname;
        String wbindexkey="basic_wbindex_"+t1showname;
        String wxindexkey="basic_wxindex_"+t1showname;
        String tgikey="basic_showtgi_"+t1showname;
    ...
    public Object getoneshow(HttpServletRequest request){
        ...
        String t1showtypekey="basic_showtype_"+showname;
